...
public class EditLineSalesZ1 {
  ...
  public void fechAllSales() {
    ...
    try {
      ...
      MainFiles.escribirLogDefault(new Object[] { PAQUETE_OBJETO + ".fechAllSales()", "Problemas al consultar la transaccion", query, e.toString() });
    } 
  }
  ...
  public void saveSales() {
    ...
    try {
      ...
      MainFiles.escribirLogDefault(new Object[] { PAQUETE_OBJETO + ".masterFuncionSalesZ1()", "QUERY: ", query });
      try {
        if (!this.BD.sqlInsert(query) || this.BD.sqlCommit());
      } catch (Exception e) {
        MainFiles.escribirLogDefault(new Object[] { PAQUETE_OBJETO + ".masterFuncionSalesZ1()", "Hubo problemas en registrar el Pedido en la Z1", query });
      } 
    } catch (Exception e) {
